...
static inline bool _mppt_Stream_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct mppt_Stream* msg, bool tao);
...
/*
 decode mppt_Stream, return true on failure, false on success
*/
bool _mppt_Stream_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct mppt_Stream* msg, bool tao) {
