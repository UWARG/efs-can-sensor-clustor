...
#define A121_SPI_SS_GPIO_Port GPIOA // REPLACE WITH REAL PIN
#define A121_SPI_SS_Pin GPIO_PIN_0 // REPLACE WITH REAL PIN

#define SEN_EN1_GPIO_Port GPIOA // REPLACE WITH REAL PIN
#define SEN_EN1_Pin GPIO_PIN_1 // REPLACE WITH REAL PIN

#define SEN_INT1_GPIO_Port GPIOA // REPLACE WITH REAL PIN
