...
SPI_HandleTypeDef* A121_SPI_HANDLE = &hspi1;
...
//#define SPI_SEL0_Pin 1
//#define SPI_SEL1_Pin 2
//#define SPI_SEL2_Pin 3

#define SPI_SEL0_GPIO_Port 4
#define SPI_SEL1_GPIO_Port 5
#define SPI_SEL2_GPIO_Port 6

#define A121_SPI_SS_GPIO_Port GPIOB // REPLACE WITH REAL PIN
#define A121_SPI_SS_Pin GPIO_PIN_5 // REPLACE WITH REAL PIN

#define SEN_EN1_GPIO_Port GPIOB // REPLACE WITH REAL PIN
#define SEN_EN1_Pin GPIO_PIN_6 // REPLACE WITH REAL PIN

#define SEN_INT1_GPIO_Port GPIOB
#define SEN_INT1_Pin GPIO_PIN_8
